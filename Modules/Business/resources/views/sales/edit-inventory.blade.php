            ...
            <div class="order-form-section p-16">
                <form action="{{ route('business.sales.update', $sale->id) }}" method="post" enctype="multipart/form-data" class="ajaxform">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-8 {{ $sale->party_id === null || $sale->party_id === 'guest' ? '' : 'd-none' }} guest_phone">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 mt-5">
                            <div class="amount-info-container inventory-amount-info-container">
                                <div class="row amount-container  align-items-center mb-2">
                                    ...
                                    <input name="receive_amount" type="number" step="any" id="receive_amount" value="{{ $sale->change_amount + $sale->paidAmount }}" min="0" class="form-control" placeholder="0">
                                </div>
                                <div class="row amount-container  align-items-center mb-2">
