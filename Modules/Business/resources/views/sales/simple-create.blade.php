                                ...
                                <div class="product-selected">
                                    <span id="selectedValue">{{ __('Select Product') }}</span><span id="arrow">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            ...
                                            <path d="M4 6L8 10L12 6" stroke="#4B5563" stroke-width="1.5"
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        @if($stock)
                                            <div class="product-option-item single-product {{ $product->id }} add-batch-item"
                                                 ...
                                                 data-default_price="{{ $stock->productSalePrice ?? $product->productSalePrice }}"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between w-100">
                                                        <div class="product-des">
                                                            ...
                                                            <span class="product-in-stock">
                                                                {{ __('In Stock') }}: {{ $stock->productStock ?? 0 }}
                                                            </span>
                                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="button-group text-center ">
                                <button data-route="{{ route('business.carts.remove-all') }}"
                                        class="theme-btn border-btn m-2">
                                    {{ __('Cancel') }}
                                </button>
