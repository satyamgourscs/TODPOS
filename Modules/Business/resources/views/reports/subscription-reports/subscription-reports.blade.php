            ...
            <div class="card-bodys">
                ...
                <div class="table-top-form p-16">
                    ...
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                            <form action="{{ route('business.subscription-reports.filter') }}" method="post"
                                class="report-filter-form" table="#subscription-report-data">
                                @csrf
                                        ...
                                        <div class="gpt-up-down-arrow position-relative d-print-none custom-date-filter">
                                            ...
                                            <div class="calendar-icon">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    ...
                                                    <path d="M10.666 1.33203V3.9987" stroke="white" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M5.33398 1.33203V3.9987" stroke="white" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M2 6.66797H14" stroke="white" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </div>
                                        </div>
