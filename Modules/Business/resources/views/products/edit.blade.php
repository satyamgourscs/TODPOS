...
@section('main_content')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="category_id" id="category-select-edit" class="form-control table-select w-100 role">
                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="brand_id" class="form-control table-select w-100 role">
                                                        ...
                                                        @foreach ($brands as $brand)
                                                            <option value="{{ $brand->id }}" @selected($brand->id == $product->brand_id)> {{ ucfirst($brand->brandName) }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span></span>
                                                </div>
                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select name="model_id" class="form-control table-select w-100 role">
                                                        ...
                                                        @foreach ($product_models as $model)
                                                            <option value="{{ $model->id }}" @selected($model->id == $product->model_id)> {{ ucfirst($model->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span></span>
                                                </div>
                                            ...
                                            @endif
                                                            ...
                                                            <select name="stocks[0][warehouse_id]" class="form-control table-select w-100 role">
                                                                ...
                                                                @foreach ($warehouses as $warehouse )
                                                                    <option value="{{ $warehouse->id }}"
                                                                        @selected($warehouse->id == optional($singleStock)->warehouse_id)>
                                                                        {{ $warehouse->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="gpt-up-down-arrow position-relative">
                                                        <select name="rack_id" id="rack_id" class="form-control table-select w-100 role">
                                                            ...
                                                            @foreach ($racks as $rack)
                                                                <option value="{{ $rack->id }}" @selected($rack->id == $product->rack_id)>
                                                                    {{ $rack->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-lg-4 mb-2">
                                                    ...
                                                    <div class="gpt-up-down-arrow position-relative">
                                                        <select name="shelf_id" id="shelf_id" class="form-control table-select w-100 role">
                                                            <option value="">{{ __('Select one') }}</option>
                                                            {{-- shelves will be loaded dynamically via JS --}}
                                                        </select>
                                                        <span></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between">
                                            ...
                                            <div class="dual-dropdown">
                                                ...
                                                <select id="vat_type" name="vat_type">
                                                    <option value="exclusive" {{ $product->vat_type == 'exclusive' ? 'selected' : '' }}>Exclusive</option>
                                                    <option value="inclusive" {{ $product->vat_type == 'inclusive' ? 'selected' : '' }}>Inclusive</option>
                                                </select>
                                            </div>
                                            @endif
                                            @if ($hasVisibleColumn)
                                    ...
                                    <table class="table" id="datatable">
                                        ...
                                        @if ($product->product_type == 'variant')
                                            ...
                                            <tr>
                                                @if (is_module_enabled($modules, 'show_batch_no'))
                                                <td>
                                                    <input type="text" name="stocks[{{ $index }}][batch_no]" value="{{ $stock->batch_no }}" class="form-control form-control-sm custom-table-input" placeholder="25632">
                                                </td>
                                                @endif

                                                @if (moduleCheck('WarehouseAddon'))
                                                    @if (is_module_enabled($modules, 'show_warehouse'))
                                                        <td><select name="stocks[{{ $index }}][warehouse_id]" class="form-control table-select w-100 role">
                                                ...
                                                @if (is_module_enabled($modules, 'show_product_stock'))
                                                <td>
                                                    <input type="number" step="any" min="0" name="stocks[{{ $index }}][productStock]" value="{{ $stock->productStock }}" class="form-control form-control-sm custom-table-input" placeholder="3">
                                                </td>
                                                @endif
                                                @usercan('products.price')
                                                @if (is_module_enabled($modules, 'show_exclusive_price'))
                                                <td>
                                                    ...
                                                    value="{{ $product->vat_type == 'exclusive'  ? $stock->productPurchasePrice
                                                        : $stock->productPurchasePrice - (($stock->productPurchasePrice * ($product->vat->rate ?? 0)) / (100 + ($product->vat->rate ?? 0))) }}"
                                                    placeholder="Ex: 50">
                                                </td>
                                                @endif
                                                @if (is_module_enabled($modules, 'show_inclusive_price'))
                                                <td>
                                                    <input type="number" step="any" min="0" class="form-control form-control-sm custom-table-input inclusive_price" name="stocks[{{ $index }}][inclusive_price]"
                                                           value="{{ $stock->productPurchasePrice }}"
                                                           placeholder="Ex: 50">
                                                </td>
                                                @endif
                                                @if (is_module_enabled($modules, 'show_profit_percent'))
                                                <td>
                                                    <input type="number" class="form-control form-control-sm custom-table-input profit_percent" name="stocks[{{ $index }}][profit_percent]" value="{{ $stock->profit_percent }}" placeholder="25%">
                                                </td>
                                                @endif
                                                @endusercan
                                                @if (is_module_enabled($modules, 'show_product_sale_price'))
                                                <td>
                                                    <input type="number" step="any" min="0" class="form-control form-control-sm custom-table-input productSalePrice" name="stocks[{{ $index }}][productSalePrice]" value="{{ $stock->productSalePrice }}" placeholder="Ex: 200">
                                                </td>
                                                @endif
                                                @if (is_module_enabled($modules, 'show_product_wholesale_price'))
                                                <td>
                                                    <input type="number" step="any" min="0" name="stocks[{{ $index }}][productWholeSalePrice]" value="{{ $stock->productWholeSalePrice }}" class="form-control form-control-sm custom-table-input" placeholder="Ex: 200">
                                                </td>
                                                @endif
                                                @if (is_module_enabled($modules, 'show_product_dealer_price'))
                                                <td>
                                                    <input type="number" step="any" min="0" name="stocks[{{ $index }}][productDealerPrice]" value="{{ $stock->productDealerPrice }}" class="form-control form-control-sm custom-table-input" placeholder="Ex: 200">
                                                </td>
                                                @endif
                                ...
                                <div class="row">
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_stock'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productStock]" class="form-control"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->productStock : 0 }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_exclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control exclusive_price" name="stocks[0][exclusive_price]"
                                                   value="{{ $isSingle && $singleStock ? ($singleStock->vat_type == 'exclusive' ? $singleStock->productPurchasePrice : $singleStock->productPurchasePrice - $product->vat_amount) : 0 }}"
                                    ...
                                    @if (is_module_enabled($modules, 'show_inclusive_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control inclusive_price" name="stocks[0][inclusive_price]"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->productPurchasePrice : 0 }}"
                                                   placeholder="Enter Purchase Price" required>
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_profit_percent'))
                                        <div class="col-lg-6 mb-2">
                                            <label>Profit (%)</label>
                                            <input type="number" class="form-control profit_percent" name="stocks[0][profit_percent]"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->profit_percent : 0 }}">
                                        </div>
                                    @endif
                                    @endusercan
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_sale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" class="form-control productSalePrice" name="stocks[0][productSalePrice]"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->productSalePrice : 0 }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_wholesale_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productWholeSalePrice]" class="form-control"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->productWholeSalePrice : 0 }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (is_module_enabled($modules, 'show_product_dealer_price'))
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="number" name="stocks[0][productDealerPrice]" class="form-control"
                                                   value="{{ $isSingle && $singleStock ? $singleStock->productDealerPrice : 0 }}">
                                        </div>
                                    @endif
    ...
    <input type="hidden" id="selectedShelfId" value="{{ $product->shelf_id }}">
