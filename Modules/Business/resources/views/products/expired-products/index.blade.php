                ...
                <div class="card-bodys">
                    ...
                    <div class="table-top-form p-16">
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            <form action="{{ route('business.products.expired.filter') }}" method="post" class="filter-form" table="#expired-product-data">
                                @csrf
                        ...
                        <div class="table-top-btn-group d-print-none">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('business.products.expired.csv') }}">
                                        <img src="{{ asset('assets/images/logo/csv.svg') }}" alt="">
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ route('business.products.expired.excel') }}">
                ...
                <div class="responsive-table m-0">
                    <table class="table">
                        ...
                        <tbody id="expired-product-data">
                            @include('business::products.expired-products.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    @include('business::products.expired-products.view')
@endpush
