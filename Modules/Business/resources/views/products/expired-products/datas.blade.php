@foreach ($expired_products as $product)
    ...
    <tr>
        <td>{{ ($expired_products->currentPage() - 1) * $expired_products->perPage() + $loop->iteration }}</td>
            ...
            <td class="{{ $product->stocks_sum_product_stock <= $product->alert_qty ? 'text-danger' : 'text-success' }}">
                ...
                <div class="dropdown table-action">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <a href="#expire-product-view" class="product-view" data-bs-toggle="modal"
