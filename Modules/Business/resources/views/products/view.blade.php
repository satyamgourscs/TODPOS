            ...
            <div class="modal-body order-form-section">
                <div class="costing-list">
                    <ul>
                        ...
                        <li><span>{{ __('Purchase price') }}</span> <span>:</span> <span
                                id="product_purchase_price"></span></li>
                        ...
                        <li id="expire_date_row" class="d-none"><span>{{ __('Expire Date') }}</span> <span>:</span> <span id="expire_date"></span></li>
