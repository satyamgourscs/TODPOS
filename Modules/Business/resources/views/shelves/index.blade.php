            ...
            <div class="card ">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        @usercan('shelfs.create')
                            <a type="button" href="#shelf-create-modal" data-bs-toggle="modal" class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new') }}</a>
                        @endusercan
                    </div>

                    <div class="table-top-form p-16">
                        <form action="{{ route('business.shelfs.filter') }}" method="post" class="filter-form" table="#shelf-data">
                            @csrf
                ...
                <div class="delete-item delete-show d-none">
                    <div class="delete-item-show">
                        ...
                        <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal" data-url="{{ route('business.shelfs.delete-all') }}">{{ __('Delete') }}</button>
                    </div>
                </div>
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="datatable">
                        ...
                        <tbody id="shelf-data">
                            @include('business::shelves.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    ...
    @include('business::shelves.create')
    @include('business::shelves.edit')
@endpush
