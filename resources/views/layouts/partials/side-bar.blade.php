        ...
        <ul>
            ...
            <li class="{{ Request::routeIs('admin.addons.index') ? 'active' : '' }}">
                <a href="{{ route('admin.addons.index') }}" class="active">
                    ...
                    {{ __('Add-ons') }}
                    <sup class="badge bg-warning position-absolute side-bar-addon">New</sup>
            ...
            {{-- @canany(['settings-read', 'notifications-read', 'currencies-read', 'gateways-read'])
                <li
                    class="dropdown {{ Request::routeIs('admin.settings.index', 'admin.notifications.index', 'admin.system-settings.index', 'admin.currencies.index', 'admin.currencies.create', 'admin.currencies.edit', 'admin.gateways.index') ? 'active' : '' }}">
                    <a href="#">
                        <span class="sidebar-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
