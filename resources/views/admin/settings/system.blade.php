                            ...
                            <div class="cards-header shadow">
                                <div class="card-body">
                                    <ul class="nav nav-pills flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#social-login" class="add-report-btn nav-link" data-bs-toggle="tab">{{ __('Social Login') }} <sup class="badge bg-warning">Add-On</sup></a>
                                        </li>
                                        @endif
                                        <li class="nav-item">
                                    ...
                                    <form action="{{ route('admin.system-settings.store') }}" method="post" class="ajaxform">
                                        ...
                                        <div class="tab-content no-padding">
                                            ...
                                            <div class="tab-pane fade" id="mail-configuration">
                                                ...
                                                <span>{{ __('QUEUE COMMAND Path :') }} <span class="text-danger">{{ __('/home/u186958312/domains/maanai.tryonedigital.com/public_html/maanai') }}</span></span><br>
