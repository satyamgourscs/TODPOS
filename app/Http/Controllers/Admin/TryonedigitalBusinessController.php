...
class TryonedigitalBusinessController extends Controller
{
    ...
    public function tryonedigitalFilter(Request $request)
    {
        ...
        $businesses = Business::with('enrolled_plan:id,plan_id', 'enrolled_plan.plan:id,subscriptionName', 'category:id,name', 'user:id,email')
